...
describe("Word") do
  ...
  describe('#word') do
    it('saves a value in word') do
      word = Word.new({"word" => "continent","definition" => "one of the seven main landmasses on the Earth", "def2" => "", "def3" => ""})
  ...
  describe('#add_word') do
    it("adds words to the word list") do
      word1 = Word.new({"word" => "continent","definition" => "one of the seven main landmasses on the Earth", "def2" => "", "def3" => ""})
      word1.add_word()
      word2 = Word.new({"word" => "country", "definition" => "a nation with its own government on a particular piece of land", "def2" => "", "def3" => ""})
      word2.add_word()
